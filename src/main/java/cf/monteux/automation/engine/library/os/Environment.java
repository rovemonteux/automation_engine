...
public class Environment {
     ...
     *
     * @return	The 4-element object array containing the Thread count (int), the
     * peak Thread count (int), the current Thread's CPU time (double) and the
     * current Thread's user time (double)
     */
